    ...
    task :send_homeless_notices => :environment do
      ...
      @courses.each do |course|
        Email.create(
          ...
          <a href='http://#{ROOT_URL}#{edit_course_path(course.id)}'>#{course.title}</a><br />
          ...
          <p>If this is appropriate for your library or archive, please <a href='http://#{ROOT_URL}#{edit_course_path(course.id)}'>edit the course</a> and assign it to your repository.</p>"
        )
      end
